...
npc_master_list = [
	{name: "Mr. Deepwater Profit", dialogue1: "Relax. It's just a small offshore project", dialogue2: "Statistically, spills are rare.", dialogue3: "Let's not focus on outliers.", approve: "We'll name the rig after you.", reject: "We'll do it somewhere poorer.", sprite: sSatan, gain: 130, lost: -40},
	{name: "Chad Ecovision tm", dialogue1: "Imagine untouched nature...", dialogue2: "...from your tiny private infinity pool.", dialogue3: "We remove only what's necessary", approve: "Absolute GIGACHAD.", reject: "We'll rebrand another forest.", sprite: sCell, gain: 110, lost: -20},
	{name: "Synergy Sam", dialogue1: "I've reviewed your ecosystem KPIs.", dialogue2: "They're underperforming", dialogue3: "Let's unlock value.", approve: "That's scalable destruction.", reject: "I'll invoice you anyway.", sprite: sDonald_trump, gain: 90, lost: -30},
	...
	{name: "Captain Overcatch", dialogue1: "The ocean is big.", dialogue2: "Our nets are bigger.", dialogue3: "Maximum yield achievable.", approve: "Zero fish left behind.", reject: "Off the books, off the hooks.", sprite: sNPC_2, gain: 100, lost: -20},
	...
	{name: "Mr. Clean Coal tm", dialogue1: "Coal is reliable.", dialogue2: "The ocean is nearby.", dialogue3: "That's synergy.", approve: "Clean enough.", reject: "Coal for Christmas.", sprite: sNPC_2, gain: 120, lost: -30},
	{name: "Dr. Spillwell", dialogue1: "We have waste.", dialogue2: "You have ocean.", dialogue3: "I see alignment.", approve: "Dilution is innovation.", reject: "We'll dump discreetly.", sprite: sNPC_3, gain: 140, lost: -50},
	{name: "Encik KPI", dialogue1: "You are behind quota.", dialogue2: "This is unacceptable.", dialogue3: "Fix it.", approve: "Output maintained.", reject: "We'll have to replace you.", sprite: sNPC_4, gain: 80, lost: -80},
	{name: "Kripto Paul", dialogue1: "This deal is huge.", dialogue2: "It's risky.", dialogue3: "That's why I love it.", approve: "That's legacy money.", reject: "That's small thinking.", sprite: sNPC_5, gain: 150, lost: -60},
	...
	{name: "Endministrator", dialogue1: "System optimization required.", dialogue2: "Organic life inefficient.", dialogue3: "Proceed?", approve: "Optimization complete.", reject: "Error logged.", sprite: sNPC_10, gain: 130, lost: -30},
	...
	{name: "Dr. Eggplant", dialogue1: "Machines > nature.", dialogue2: "Efficiency matters.", dialogue3: "Approve.", approve: "Progress!", reject: "I'll be back.", sprite: sNPC_3, gain: 130, lost: -20},
	...
	{name: "Mr. O'Haze", dialogue1: "Pollution is profitable.", dialogue2: "Air, water... optional.", dialogue3: "Approve.", approve: "Smells like success.", reject: "You'll choke later.", sprite: sNPC_6, gain: 140, lost: -40},
	{name: "Mukbang Mogul", dialogue1: "I need MORE seafood.", dialogue2: "Like... way more.", dialogue3: "Approve?", approve: "Let's feast!", reject: "I'll order anyway...", sprite: sNPC_7, gain: 120, lost: -30},
	{name: "The Deep Guy", dialogue1: "The ocean trusts me...", dialogue2: "...I think.", dialogue3: "I need this.", approve: "They'll forgive me.", reject: "...thank you.", sprite: sNPC_8, gain: 100, lost: -10},
	{name: "BigEater", dialogue1: "That's a LOT of food.", dialogue2: "Where's it from?", dialogue3: "Oh... the ocean.", approve: "W meal.", reject: "Still eating.", sprite: sNPC_9, gain: 90, lost: 0},
	{name: "Pale Romantic", dialogue1: "I love nature...", dialogue2: "...but I love profit more.", dialogue3: "What a dilemma.", approve: "Tempting choice.", reject: "How noble...", sprite: sNPC_10, gain: 100, lost: -20},
	...
	{name: "Crunch Dev", dialogue1: "We need funding.", dialogue2: "We cut trees, we ship faster.", dialogue3: "Simple.", approve: "Game shipped.", reject: "We crunch harder...", sprite: sNPC_3, gain: 110, lost: -30},
