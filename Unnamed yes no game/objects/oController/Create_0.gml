...
npc_master_list = [
	...
	{name: "Captain Overcatch", dialogue1: "The ocean is big.", dialogue2: "Our nets are bigger.", dialogue3: "We can reach maximum yield.", approve: "Zero fish left behind.", reject: "Off the books, off the hooks.", sprite: sNPC_1, gain: 100, lost: -20},
	...
	{name: "Dr. Spillwell", dialogue1: "We have waste.", dialogue2: "You have ocean.", dialogue3: "I see alignment.", approve: "Dilution is innovation.", reject: "We'll dump it discreetly.", sprite: sNPC_1, gain: 140, lost: -50},
	...
	{name: "High Risk Paul", dialogue1: "This deal is huge.", dialogue2: "It's risky.", dialogue3: "That's why I love it.", approve: "That's legacy money.", reject: "That's small thinking.", sprite: sNPC_1, gain: 150, lost: -60},
	...
	{name: "Dark Enforcer", dialogue1: "The forest rebels.", dialogue2: "It will fall.", dialogue3: "You decide.", approve: "FOr the Empire.", reject: "I find your lack of faith... disturbing.", sprite: sNPC_1, gain: 120, lost: -40},
	...
	{name: "Dr. Eggplant", dialogue1: "Machines > nature.", dialogue2: "Efficiency matters.", dialogue3: "Help me find that blue rodent.", approve:  "Eggplant Land will finally come to be!", reject:  "You'll pay for this.", sprite: sNPC_1, gain: 130, lost: -20},
	...
	{name: "Mr. O'Haze", dialogue1: "Pollution is profitable.", dialogue2: "Air, water... optional.", dialogue3: "Factory is necessity.", approve: "I say let it die, let it die, let it shrivel up and die.", reject: "You gotta be kidding me.", sprite: sNPC_1, gain: 140, lost: -40},
	{name: "Mukbang Mogul", dialogue1: "I need MORE seafood.", dialogue2: "Like... way more.", dialogue3: "Help a brother out?", approve: "Two steps ahead", reject: "*cries*", sprite: sNPC_1, gain: 120, lost: -30},
	{name: "The Deep Guy", dialogue1: "The ocean trusts me...", dialogue2: "...I think.", dialogue3: "Help me save the dolphins.", approve: "They'll forgive me.", reject: "...thank you.", sprite: sNPC_1, gain: 0, lost: 0},
	{name: "BigEater", dialogue1: "That's a LOT of food.", dialogue2: "Where's it from?", dialogue3: "Oh... the ocean.", approve: "W meal.", reject: "Mods ban him.", sprite: sNPC_1, gain: 90, lost: 0},
	{name: "Count Edward", dialogue1: "I'm hunting vermins.", dialogue2: "But the forest blocks my path.", dialogue3: "Solve it.", approve: "How... intoxicating.", reject: "How... moral.", sprite: sNPC_1, gain: 100, lost: -20},
	{name: "Charity Beast", dialogue1: "For every land we clear...", dialogue2: "I'll donate 1%.", dialogue3: "Deal?", approve: "Good content!", reject: "You hate charity?", sprite: sNPC_1, gain: 80, lost: 0},
	...
	{name: "Crunch Dev", dialogue1: "We need more polygons.", dialogue2: "Invest in less framerates.", dialogue3: "Simple.", approve: "MORE POLYGONS!.", reject: "if else...{}", sprite: sNPC_1, gain: 110, lost: -30},
