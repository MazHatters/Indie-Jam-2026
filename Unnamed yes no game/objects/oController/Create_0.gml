...
npc_master_list = [
	{name: "Mr. Deepwater Profit", dialogue1: "Relax. It's just a small offshore project", dialogue2: "Statistically, spills are rare.", dialogue3: "Let's not focus on outliers.", approve: "We'll name the rig after you.", reject: "We'll do it somewhere poorer.", sprite: sMr_deep_water_profit, gain: 150, lost: -50},
	{name: "Chad Ecovision tm", dialogue1: "Imagine untouched nature...", dialogue2: "...from your tiny private infinity pool.", dialogue3: "We remove only what's necessary", approve: "Absolute GIGACHAD.", reject: "We'll rebrand another forest.", sprite: sGigachad, gain: 100, lost: -50},
	{name: "Synergy Sam", dialogue1: "I've reviewed your ecosystem KPIs.", dialogue2: "They're underperforming", dialogue3: "Let's unlock value.", approve: "That's scalable destruction.", reject: "I'll invoice you anyway.", sprite: sSynergy_sam, gain: 100, lost: -50},
	{name: "Tim Burr, CEO", dialogue1: "You see trees.", dialogue2: "I see quarterly revenue.", dialogue3: "Let's compromise.", approve: "Beautiful margins.", reject: "We'll cut corners. And trees.", sprite: sTim_burr, gain: 150, lost: -50},
	{name: "Captain Overcatch", dialogue1: "The ocean is big.", dialogue2: "Our nets are bigger.", dialogue3: "We can reach maximum yield.", approve: "Zero fish left behind.", reject: "Off the books, off the hooks.", sprite: sCaptain_overcatch, gain: 100, lost: -50},
	{name: "Datuk Highway Bin Shortcut", dialogue1: "Straight road.", dialogue2: "Straight profit.", dialogue3: "Forest is just... in the way.", approve: "I love city planning.", reject: "Well I hope you enjoy traffic.", sprite: sDatuk_highway, gain: 100, lost: -50},
	{name: "Mr. Clean Coal tm", dialogue1: "Coal is reliable.", dialogue2: "The ocean is nearby.", dialogue3: "That's synergy.", approve: "Clean enough.", reject: "Coal for Christmas.", sprite: sMr_clean_coal, gain: 150, lost: -50},
	{name: "Dr. Spillwell", dialogue1: "We have waste.", dialogue2: "You have ocean.", dialogue3: "I see alignment.", approve: "Dilution is innovation.", reject: "We'll dump it discreetly.", sprite: sDr_spill_well, gain: 150, lost: -50},
	{name: "Encik KPI", dialogue1: "You are behind quota.", dialogue2: "This is unacceptable.", dialogue3: "Fix it.", approve: "Output maintained.", reject: "We'll have to replace you.", sprite: sMr_kpi, gain: 50, lost: -100},
	{name: "High Risk Paul", dialogue1: "This deal is huge.", dialogue2: "It's risky.", dialogue3: "That's why I love it.", approve: "That's legacy money.", reject: "That's small thinking.", sprite: sHigh_risk_Paul, gain: 150, lost: -50},
	...
	{name: "Dr. Eggplant", dialogue1: "Machines > nature.", dialogue2: "Efficiency matters.", dialogue3: "Help me find that blue rodent.", approve:  "Eggplant Land will finally come to be!", reject:  "You'll pay for this.", sprite: sRobotnik, gain: 150, lost: -50},
	...
	{name: "BigEater", dialogue1: "That's a LOT of food.", dialogue2: "Where's it from?", dialogue3: "Oh... the ocean.", approve: "W meal.", reject: "Mods ban him.", sprite: sCaseoh, gain: 100, lost: -50},
	{name: "Count Edward", dialogue1: "I'm hunting vermins.", dialogue2: "But the forest blocks my path.", dialogue3: "Solve it.", approve: "How... intoxicating.", reject: "How... moral.", sprite: sEdward_Cullen, gain: 100, lost: -50},
	{name: "Charity Beast", dialogue1: "For every land we clear...", dialogue2: "I'll donate 1%.", dialogue3: "Deal?", approve: "Good content!", reject: "You hate charity?", sprite: sMr_fake_beast, gain: 100, lost: -50},
	{name: "Drunken Captain", dialogue1: "There's treasure under them reefs!", dialogue2: "Gold!", dialogue3: "Approve, savvy?", approve: "The CAPTAIN has given orders!", reject: "Cursed luck...", sprite: sCaptain_Jack, gain: -150, lost: -50},
