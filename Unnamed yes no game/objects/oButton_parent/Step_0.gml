...
switch (object_index)
{
    ...
    case oButton_restart_room:	gui_x = (_gw / 2) - 150; gui_y = (_gh / 2) + 150; break;
    case oButton_mainmenu:		gui_x = (_gw / 2) + 150; gui_y = (_gh / 2) + 150; break;
	case oButton_play:			gui_x = (_gw / 2) - 150; gui_y = (_gh / 2) + 150; break;
	case oButton_quit:			gui_x = (_gw / 2) + 150; gui_y = (_gh / 2) + 150; break;
}
